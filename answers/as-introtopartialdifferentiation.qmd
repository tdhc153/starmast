...
abstract: Answers to questions relating to the guide on introduction to partial differentiation.
draft: true
---
...
1.4. $\displaystyle \quad \dfrac{\partial f}{\partial x} = y \mathrm{e}^{xy} + 4xy^3 \:$ and $\: \displaystyle \dfrac{\partial f}{\partial y} = x \mathrm{e}^{xy} + 6x^2y^2$.

1.5. $\displaystyle \quad \dfrac{\partial f}{\partial x} = \dfrac{1}{x} + \ln(y) + 3 \:$ and $\: \displaystyle \dfrac{\partial f}{\partial y} = \dfrac{x}{y}$.

1.6. $\displaystyle \quad \dfrac{\partial f}{\partial x} = -\dfrac{y}{x^2} \:$ and $\: \displaystyle \dfrac{\partial f}{\partial y} = \dfrac{1}{x} + \dfrac{x}{y^2}$.
...
1.11. $\displaystyle \quad \dfrac{\partial f}{\partial x} = 2x \ln(xy) + 2y \:$ and $\: \displaystyle \dfrac{\partial f}{\partial y} = \dfrac{x}{y} + 2x \ln(xy)$.

1.12. $\displaystyle \quad \dfrac{\partial f}{\partial x} = \dfrac{1}{2\sqrt{x}} \tan(y) + 5 \ln(x^2) \cos(2y) + \dfrac{10}{x} \cos(2y) \:$ and $\: \displaystyle \dfrac{\partial f}{\partial y} = \sqrt{x} \sec^2(y) + 5x$.
...
1.14. $\displaystyle \quad \dfrac{\partial f}{\partial x} = 2y(z+x) \:$ and $\: \displaystyle \dfrac{\partial f}{\partial y} = 2x(z+y) \:$ and $\: \displaystyle \dfrac{\partial f}{\partial z} = 2y(x+z)$.

1.15. $\displaystyle \quad \dfrac{\partial f}{\partial x} = \dfrac{yz(x+y+z) - xyz}{(x+y+z)^2} \:$ and $\: \displaystyle \dfrac{\partial f}{\partial y} = \dfrac{xz(x+y+z) - xyz}{(x+y+z)^2} \:$ and $\: \displaystyle \dfrac{\partial f}{\partial z} = \dfrac{xy(x+y+z) - xyz}{(x+y+z)^2}$.
...
2.5. $\displaystyle \quad \dfrac{\partial^2\!f}{\partial x^2} = \mathrm{e}^x\sin(y) \:$ and $\: \displaystyle \dfrac{\partial^2\!f}{\partial y^2} = -\mathrm{e}^x\sin(y) \:$ so $\: \displaystyle \dfrac{\partial^2\!f}{\partial x^2} + \dfrac{\partial^2\!f}{\partial y^2} = 0$.
...
3.2. $\displaystyle \quad \dfrac{\partial^2\!f}{\partial x \, \partial y} = 0 \:$ and $\: \displaystyle \dfrac{\partial^2\!f}{\partial y \, \partial x} = 0 \:$ so $\: \displaystyle \dfrac{\partial^2\!f}{\partial x \, \partial y} = \dfrac{\partial^2\!f}{\partial y \, \partial x}$.
...
3.4. $\displaystyle \quad \dfrac{\partial^2\!f}{\partial x \, \partial y} = 0 \:$ and $\: \displaystyle \dfrac{\partial^2\!f}{\partial y \, \partial x} = 0 \:$ so $\: \displaystyle \dfrac{\partial^2\!f}{\partial x \, \partial y} = \dfrac{\partial^2\!f}{\partial y \, \partial x}$.

3.5. $\displaystyle \quad \dfrac{\partial^2\!f}{\partial x \, \partial y} = \dfrac{y}{(x^2+y^2)^{3/2}} \:$ and $\: \displaystyle \dfrac{\partial^2\!f}{\partial y \, \partial x} = \dfrac{y}{(x^2+y^2)^{3/2}} \:$ so $\: \displaystyle \dfrac{\partial^2\!f}{\partial x \, \partial y} = \dfrac{\partial^2\!f}{\partial y \, \partial x}$.
