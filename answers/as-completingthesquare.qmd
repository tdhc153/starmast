...
3.3. You worked out in 1.3 that $x^2 + 8x + 20 = (x+4)^2 + 4$. Using the fact that $(\pm 2i)^2 = -4$ (see [Guide: Introduction to complex numbers](../studyguides/introtocomplexnumbers.qmd)), rearranging $(x+4)^2 + 4 = 0$ for $y$ gives $y = -4 \pm 2i$, so $y = -4 - 2i$ or $y = -4 + 2i$.
...
3.5. You worked out in 2.3 that $4x^2 + 32x + 68 = 4(x+4)^2 + 4$. Using the fact that $(\pm i)^2 = -1$ (see [Guide: Introduction to complex numbers](../studyguides/introtocomplexnumbers.qmd)), rearranging $4(x+4)^2 + 4 = 0$ for $x$ gives $x = -4 \pm i$, so $x = -4 - i$ or $x = -4 + i$.
