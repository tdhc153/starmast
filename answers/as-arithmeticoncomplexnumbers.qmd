...
1.3. $\quad (4-i\sqrt2)-(3+i\sqrt7) = 1 -(\sqrt2+\sqrt7)i$

1.4. $\quad (\sqrt8+4i)-(\sqrt5+2i) = (2\sqrt2 - \sqrt5) + 2i$

1.5. $\quad (\sqrt7+3i)+(2-i) = (\sqrt7 + 2) + 2i$

1.6. $\quad (5 + i\sqrt2) - (7 - i) + (\sqrt3 + 4i) = (\sqrt3 - 2) + (\sqrt2 + 5)i$
...
2.9. $\quad (\sqrt2 + i\sqrt3)(\sqrt8 - i\sqrt3) = 7 + i\sqrt6$
