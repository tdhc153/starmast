...
\addplot [sblu, domain=-0.5:6] {\x^2/4 + 1};
\addplot [thick,sred,domain=-0.2:1.2] {\x/4 + 0.9375};
\node (a) at (0.5,1.0625) [circle,draw,fill=black] {};
\addplot [thick,sred,domain=1.4:2.6] {\x};
\node (b) at (2,2) [circle,draw,fill=black] {};
\addplot [thick,sred,domain=3:4] {7*\x/4 - 2.0625};
\node (c) at (3.5,4.0625) [circle,draw,fill=black] {};
