...
\node(o) at (-1.5,0) {};
\node(h) at (0,0.75) {\;\textsf{red}\;};
\node(t) at (0,-0.75) {\;\textsf{blue}\;};
\draw[->] (o) -- (h) node [pos=0.6, fill=white] {$2/5$};
\draw[->] (o) -- (t) node [pos=0.6, fill=white] {$3/5$};
\node(h1) at (1.5,1.15) {\;\textsf{red}};
\node(t1) at (1.5,0.35) {\;\textsf{blue}};
\node(h2) at (1.5,-0.35) {\;\textsf{red}};
\node(t2) at (1.5,-1.15) {\;\textsf{blue}};
\draw[->] (h) -- (h1) node [pos=0.6, fill=white] {$1/4$};
\draw[->] (h) -- (t1) node [pos=0.6, fill=white] {$3/4$};
\draw[->] (t) -- (h2) node [pos=0.6, fill=white] {$2/4$};
\draw[->] (t) -- (t2) node [pos=0.6, fill=white] {$2/4$};
