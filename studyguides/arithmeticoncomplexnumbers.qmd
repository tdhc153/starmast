...
{{< video https://youtu.be/TEYI5PiF5nA aspect-ratio="16x9">}}
...
![An Argand diagram with two complex numbers: $-1+5i$ and $3-4i$ displayed.](./FiguresPNG/complexarithmetic-fig1.png){fig-alt="An Argand diagram with two complex numbers - z = -1+5i and w = 3-4i displayed. The x-axis is labelled Re and the y-axis is labelled Im, giving four quadrants. z is located in the bottom right quadrant, and w is located in the top left quadrant." #fig-1}
...
You can do this by expanding the brackets and using the fact that $i^2 = -1$. (For more information on this please see [Guide: Expanding brackets]).
...
![An Argand diagram with the complex number: $3-4i$ displayed.](./FiguresPNG/complexarithmetic-fig3.png){fig-alt="An Argand diagram with the complex number: z = 3-4i displayed. The x-axis is labelled Re and the y-axis is labelled Im, giving four quadrants. z is in the bottom right quadrant." #fig-3} 
...
![An Argand diagram with the complex numbers: $z=3-4i$ and the product $2(3-4i) = 6-8i$ displayed.](./FiguresPNG/complexarithmetic-fig4.png){fig-alt="An Argand diagram with the complex numbers z = 3-4i and 2z = 6-8i displayed. The x-axis is labelled Re and the y-axis is labelled Im, giving four quadrants. Both z and 2z are in the bottom right quadrant, with 2z being further away from the origin than z in exactly the same direction." #fig-4}
...
Whereas multiplying a complex number by a real number gives a scaling effect, multiplying two complex numbers together gives a transformation by both *scaling* and *rotation*. The reason for this is due to the deep relationship between complex numbers and trigonometry. See [Guide: Modulus-argument form of complex numbers] for more. 
