...
*Before reading this guide, it is recommended that you read [Guide: Introduction to probability](introtoprobability.qmd), [Guide: Expected value, variance, standard deviation](expectedvariance.qmd), and [Guide: PMFs, PDFs, CDFs](pmfspdfscdfs.qmd).*
...
Here's some examples of hypotheses that require testing. In these examples, the Greek letter $\mu$ (mu) is used for the **population mean**; see [Guide: Expected value, variance, standard deviation](expectedvariance.qmd) for more. 
...
{{< video https://youtu.be/2tHJXTtCLqc aspect-ratio="16x9">}}
...
https://youtu.be/2tHJXTtCLqc (Introduction to hypothesis testing - Example 1 | STARMAST)
...
You can use two different but equivalent methods to decide whether or not to reject your hypothesis to the stated significance level. These methods depend on **the probability distribution being used**; see [Guide: PMFs, PDFs, CDFs](pmfspdfscdfs.qmd) and [Overview: Probability distributions](../overviews/o-distributions.qmd) for more.
