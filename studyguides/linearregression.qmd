...
To find the equation of the regression line for a population of data, you will need to find the $y$-intercept of the line, which will be written as $\alpha$, and its gradient, which will be described as $\beta$. 
...
In practice, it is impractical to work with an entire population of data; what if there were millions of samples? Instead, statisticians analyze **samples** of the population. This means that you will need to obtain **estimates** for the values of $\alpha$ and $\beta$ from your sample of data, and these will be denoted by $\hat{\alpha}$ and $\hat{\beta}$.
