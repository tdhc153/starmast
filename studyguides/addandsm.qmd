...
In column vector notation, the addition of $\mathbf{a} = \begin{pmatrix}a_1\\a_2\\a_3\end{pmatrix}$ and
...
You are given $\mathbf{a} = \begin{pmatrix}3\\4\\-2\end{pmatrix}$ and $\mathbf{b} = \begin{pmatrix}5\\6\\14\end{pmatrix}$.
Then $$\mathbf{a} + \mathbf{b} = \begin{pmatrix}3\\4\\-2\end{pmatrix} + \begin{pmatrix}5\\6\\14\end{pmatrix} = \begin{pmatrix}3+5\\4+6\\-2 + 14\end{pmatrix} = \begin{pmatrix}8\\10\\12\end{pmatrix}.$$
...
$$\mathbf{a} - \mathbf{b} = (a_1-b_1) \mathbf{i} + (a_2 - b_2) \mathbf{j} + (a_3 - b_3)\mathbf{k}$$ or, in column notation, $$\mathbf{a} - \mathbf{b} = \begin{pmatrix}a_1 - b_1\\a_2 - b_2\\a_3 - b_3\end{pmatrix}.$$
...
You are given $\mathbf{a} = \begin{pmatrix}3\\0\\-2\end{pmatrix}$ and $\mathbf{b} = \begin{pmatrix}5\\6\\-14\end{pmatrix}$.
Then $$\mathbf{a} - \mathbf{b} = \begin{pmatrix}3\\0\\-2\end{pmatrix} - \begin{pmatrix}5\\6\\-14\end{pmatrix} = \begin{pmatrix}3-5\\0-6\\-2 - (-14)\end{pmatrix} = \begin{pmatrix}-2\\-6\\12\end{pmatrix}.$$
:::
...
$\mathbf{b} = \begin{pmatrix}7\\2\\1\end{pmatrix}$ and $\mathbf{c} = \begin{pmatrix}-3\\-2\\5\end{pmatrix}.$ 
...
$\overrightarrow{AB} = \begin{pmatrix}1\\1\\-6\end{pmatrix}$, what are the co-ordinates of $A$?

Using knowledge from [Guide: Introduction to vectors](introductiontovectors.qmd), you can say that the position vector of the point $B$ is $$\overrightarrow{OB} = \begin{pmatrix}-5\\-2\\-4\end{pmatrix}$$
...
$$\overrightarrow{OA} = \overrightarrow{OB} - \overrightarrow{AB}= \begin{pmatrix}-5\\-2\\-4\end{pmatrix} - \begin{pmatrix}1\\1\\-6\end{pmatrix} = \begin{pmatrix}-6\\-3\\2\end{pmatrix}$$
