...
# Distinguishing between descriptive statistics and inferential statistics {.unnumbered}
...
An employee wanted to see how the weights data was distributed (in other words, the "shape" of the data), so they decided to plot this data in the form of a histogram: PICTURE HERE LATER
...
(COPIED DIRECTLY FROM HYPOTHESIS TESTING GUIDE)
...
Here is the formula for confidence interval: $$\textrm{CI}=\overline{x}\pm z\frac{s}{\sqrt{n}}$$
...
(IM CONCERNED THIS MAY BE WAY ABOVE THE DIFFICULTY LEVEL, NOT SURE WHAT TO DO WITH THIS EXAMPLE)
:::
...
(MIGHT BE NICE TO INTEGRATE INTERACTIVE FIGURES IN THIS SECTION)
