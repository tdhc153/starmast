...
$$\overline{x} = \frac{40+32+56+76+32+32+50}{7} \approx 38.4$$
:::
...
Cantor's Confectionery recorded a sample of the number of candies it had sold for the past 7 days. This can be summarized by the following list: $\{40,32,56,76,32,32,56\}$.
...
You can first order the list: $\{32,32,32,40,50,56,76\}$. Then you can split the list into two subsets: the upper half and the lower half. Since 40 is the value in the exact middle, it will not be included in the subsets.
...
## Correlation test and regression {.unnumbered}
