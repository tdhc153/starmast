...
abstract: Data analysis is the process of inspecting and transforming data in order to extract useful insights. This guide will outline key techniques in descriptive and inferential statistics.
draft: true
---
...
# What is data analysis? {.unnumbered}
...
This guide introduces you to data analysis. First, a distinction will be made between how to present, transform, interpret data (known as **descriptive statistics**), and how to draw conclusions from data (known as **inferential statistics**). On the descriptive statistics side, you will learn about measures of central tendency and dispersion, alongside data visualization. On the other hand, the inferential statistics section will introduce hypothesis testing, statistical relationships, and confidence intervals. It will also cover PMFs, PDFs, and CDFs.

# What do you want to do? {.unnumbered}

If you want to summarize or describe a set of data, then you need techniques from **descriptive statistics**. For example, you could ask questons like:

- what is the "middle value" of the data?
- how spread out is the data? 
- what does the data look like in visual form, and what is the best way tou can do this. 

There are several techniques you can use to answer such questions, which will be explored further in this guide.

If you want to draw statistical conclusions using **inferential statistics**, it is useful to establish what a **sample** and **population** is. A **population** is the entirety of a group you want to study. Unfortunately, a population often contains too many individuals, so it is often inconvenient or sometimes even impossible to study every individual. Because of this, a **sample,** or a smaller subset of a population, is commonly taken for a statistical study.

You can then use these samples to make inferences and predictions about the population. If so, techniques from **inferential statistics** can help you. This can be done by testing whether the values of two data samples are significantly different, examining whether two variables have a statistically significant relationship, and more that is beyond the scope of this study guide.

# Descriptive statistics {.unnumbered}

## Central tendency {.unnumbered}

The **central tendency** of data, often called the **average**, is the typical and middle value of a data set. The three most common measures of central tendency are **mean**, **median**, and **mode**.
...
-   $\overline{x}$ is used for a **sample mean**

-   $\mu$ is used for a **population mean**
...
The **median** is the middle value in a data set that is ordered from smallest to largest. 
...
Notice that the list contains 7 objects, which is an odd number. So to find the middle number in the data set, you can divide the total amount of numbers by 2 and round it up. In this case, $\frac{7}{2} = 3.5$, which rounds up to $4$.

The fourth number in the set, which is also the **median**, is 44.
:::
...
Notice that the list contains 6 objects, and $6$ is an even number. So to find the two middle numbers, you can divide the number of numbers by 2. In this case, $\frac{6}{2} = 3$. Then the two middle numbers would be the third and fourth numbers.

The third number is 32, whereas the fourth number is 44. To find the median, you can sum these numbers together and divide them by 2. So the median is $\frac{32+44}{2}=38$.
...
Once again, Cantor's Confectionery recorded a sample of the number of candies it had sold for the past 7 days; the data is given by the list $\{44,32,56,76,32,32,56\}$.
...
### Standard deviation and variance {.unnumbered}
...
For more information on standard deviation and variance, please read [Guide: Expected value, variance, standard deviation.](../studyguides/expectedvariance.qmd)
...
An employee wanted to quickly compare candy sales across different categories, so they decided to plot this data in the form of a bar chart: ![](./FiguresPNG/candysalesbarchart.png)
...
An employee wanted to see how the sales fluctuated over time, so they decided to plot this data in the form of a line graph: ![](./FiguresPNG/saleslinegraph.png)
...
An employee wanted to see how the weights data was distributed (in other words, the "shape" of the data), so they decided to plot this data in the form of a histogram: ![](./FiguresPNG/candyweightshistogram.png)
...
An employee wanted to visualize how each category compares to the whole and decided to plot this data in the form of a pie chart: ![](./FiguresPNG/candysalespiechart.png)
...
An employee wanted to see, at a glance, whether there was any correlation between candy prices and number of sales. They decided to plot this data in the form of a scatter plot: ![](./FiguresPNG/cantorscatterplot.png)
...
The bridge between descriptive and inferential statistics is **distributions**. This refers to the "shape" of the data, or how the data points are spread out. Some common distributions include the normal distribution (as mentioned in the histogram section), binomial distribution, and Poisson distribution. For more information on common distributions, please read [Overview: Probability distributions.](./overviews/o-distributions)
...
For more information on hypothesis testing, please read [Guide: Introduction to hypothesis testing.](../studyguides/hypothesistesting.qmd)

## Correlation tests and regression analysis {.unnumbered}
...
![](./FiguresPNG/cantorscatterplotwithline.png)
...
For more information on PMFs, PDFs, and CDFs, please read [Guide: PMFs, PDFs, and CDFs.](../studyguides/pmfspdfscdfs.qmd)
...
1.  What is the median of this data set? $\{3,1,2,4,4\}$

Answer: The median of this data set is `r fitb(3)`.

2.  What is the range of this data set? $\{16,7,900,4,3\}$.

Answer: The range of this data set is `r fitb(897)`.

3.  A student wants to visualize their budget, seeing how the percentage of each spending category compares to the whole budget. What type of data visualization would suit this best?

Answer: The type of data visualization that would suit this best is `r mcq(c("bar chart","line graph", "histogram",answer = "pie chart","scatter plot"))`.

4.  You are given three statements below. Decide whether they are true or false.

<!-- -->

(a) For discrete distributions, $\mathbb{P}(X\ge x)=1-\mathbb{P}(X\le x)$. Answer: `r torf(FALSE)`.

(b) The smaller the sample size, the likelier it will be that the regression model is accurate. Answer: `r torf(FALSE)`.

(c) A significant difference between the mean and median can indicate the presence of an outlier. Answer: `r torf(TRUE)`.
:::
...
(a) For discrete distributions, $\mathbb{P}(X\ge x)=1-\mathbb{P}(X\le x)$.

(b) The smaller the sample size, the likelier it will be that the regression model is accurate.

(c) A significant difference between the mean and median can indicate the presence of an outlier.
