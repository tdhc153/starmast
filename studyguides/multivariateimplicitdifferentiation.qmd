...
*Before reading this guide, it is recommended that you read [Guide: Multivariate chain rule](multivariatechainrule.qmd) and \[Guide: Introduction to implicit differentiation\].*
...
The fuel efficiency of a car depends on speed, tire pressures, and engine temperature. These variables are all related, but there is no specific formula that tells you how one affects another directly. To find how one variable changes with respect to another, you need to use multivariate implicit differentiation.
