...
In this guide, logarithms are only used to undo exponentiation to solve equations; there will not be any applications of the laws of logarithms nor the change of base rule. (For more on these, see [Guide: Introduction to logarithms](logarithms.qmd).)
