...
You may find that $(x+p)^2$ is equal to a negative number. You can use **imaginary numbers** to then solve the quadratic. See [Guide: Introduction to complex numbers] for more.
...
Suppose that you want to solve the quadratic equation $y^2 - 10y + 41 = 0$. You completed the square of $y^2 - 10y + 41$ in Example 3, getting $(y - 5)^2 + 16$. So $(y - 5)^2 + 16 = 0$; taking the $16$ over gives $(y-5)^2 = -16$. Using imaginary numbers (see [Guide: Introduction to complex numbers]) gives $$y-5 = \pm 4i$$ Therefore $y = 5 + 4i$ and $y = 5 - 4i$ are the two complex solutions of $y^2 - 10y + 41 = 0$.
