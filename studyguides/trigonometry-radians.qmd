...
<script>
  ...
  calculator3.setExpression({ id: 't', latex: 't=0', sliderBounds: { min: '0', max: '2\\pi', step: '\\pi/24'}});
  ...
  calculator3.setExpression({ id: 'ct', latex: '\\cos(t)', text: 'length of horizontal line segement', color: "#3F68B6" });
