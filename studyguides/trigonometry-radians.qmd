...
<!--   calculator3.setMathBounds({ left: -3, right: 3, bottom: -3, top: 3}); -->
<!--   calculator3.setExpression({ id: 't', latex: 't=0' }); -->
<!--   calculator3.setExpression({ id: "1", type: "expression", latex: "(\\cos(t),\\sin(t))", pointStyle: "POINT", hidden: false, secret: false, color: "#DB4315"}); -->
<!--   calculator3.setExpression({ id: 'line1', latex: 'x^2 + y^2 = 1', color: '#000000' }); -->
<!--   calculator3.setExpression({ id: 'ct', latex: '\\cos(t)' }); -->
<!--   calculator3.setExpression({ id: 'st', latex: '\\sin(t)' }); -->
<!-- </script> -->
...
&= \frac{1}{1/\sqrt{2}} + \frac{1}{1/\sqrt{3}} + \frac{1}{1/2} 
&= \sqrt{2} + \sqrt{3} + 2\\[1em]
\end{align*}
