---
title: Introduction to row reduction
author: Sara Delgado Garcia 
abstract-title: Summary 
abstract: Row-reduction (also called Gaussian elimination) is integral to solving systems of simultaneous linear equations. You can use row reduction to get a 'nicer' equivalent of a matrix.
categories: 
  - Linear mathematics 
draft: true 
---
