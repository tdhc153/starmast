...
$$
     \tau = \frac{11 -12}{\sqrt{(\frac{0.49^2}{15}) + (\frac{0.49^2}{18})}} = -5.8375\qquad \textsf{ to 4dp.}
$$
...
$$
    \tau = \frac{92 - 91.45}{\sqrt{(\frac{0.4^2}{23})+ (\frac{0.25^2}{21})}} = 5.5185\qquad \textsf{ to 4dp.}
$$
:::
...
$$
\tau = \frac{4.22 - 5.12}{1.23/ \sqrt{25}} = -3.6585\qquad \textsf{ to 4dp.}
$$
...
$$
    \tau = \frac{4.22 - 3.76}{\sqrt{(\frac{1.23^2}{25})+(\frac{1.39^2}{25})}} = 1.2392\qquad \textsf{ to 4dp.}
$$
