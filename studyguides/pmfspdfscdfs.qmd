...
categories:
  - Probability
  - Statistics
image: FiguresPNGpmfspdfscdfs-1-1.png
---
...
<script>
  ...
  calculator3.setMathBounds({ left: -4, right: 4, bottom: -0.5, top: 1});
  calculator3.setExpression({ id: '\\mu', latex: '\\mu=0', sliderBounds: { min: '-3', max: '3', step: '0.1'}});
  calculator3.setExpression({ id: '\\sigma', latex: '\\sigma=1', sliderBounds: { min: '0.1', max: '4', step: '0.1'}});
  calculator3.setExpression({ id: "3", type: "expression", latex: 'y = \\frac{1}{\\sqrt{2\\pi\\sigma^2}}\\exp(-\\frac{(x-\\mu)^2}{2\\sigma^2})', pointStyle: "POINT", hidden: false, secret: true, color: "#3F68B6"});
