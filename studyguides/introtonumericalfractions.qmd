...
```{=html}
<table><tr><td style="vertical-align: middle"><strong>Narration of study guide:</strong>&nbsp;&nbsp;</td><td><audio controls><source src="./Narrations/introtonumericalfractions.mp3" type="audio/mpeg">Your browser does not support the audio element.</audio></tr></table>
```
...
If you would like to check your answers for the highest common factor of two integers, you can use our calculator at [Calculator: Highest common factor, lowest common multiple](../apps/calculators/c-hcflcm.qmd).

:::

Highest common factors are used in the process of determining whether a fraction is fully simplified or not. The method for fully simplifying a fraction depends on finding the highest common factor.
