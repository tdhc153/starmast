...
This definition extends the trigonometric functions to situations outside right-angled triangles; dramatically increasing their usability.
...
v1.0: initial version created 08/23 by Dzhemma Ruseva, Ellie Gurini, Ciara Cormican as part of a University of St Andrews STEP project.
  ...
  - v1.1: edited 04/24 by tdhc, and split into a version using degrees and a version using radians. 
