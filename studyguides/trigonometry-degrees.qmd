...
categories:
  - Geometry
  - Trigonometry
image: FiguresPNG/trigonometry-image.png
---
...
![A right-angled triangle with sides labelled in relation to angle $\theta$.](./FiguresPNG/intrototrig-fig1-1.png){width="100%" fig-alt="A right triangle labeled with its sides in relation to angle θ (theta), which is located at the bottom left corner. The side opposite angle θ is labeled "opposite," the side next to angle θ and not the hypotenuse is labeled "adjacent," and the longest side is labeled "hypotenuse." The triangle includes a right angle in the bottom right corner." #fig-1}
...
<!--     const calculator = Desmos.Geometry(elt); -->

<!--     const sqrt3 = Math.sqrt(3); -->

<!--     calculator.setGeometry([ -->
<!--       // Triangle 1: sides 1, √3, 2 (π/6) -->
<!--       { type: "point", id: "A1", x: 0, y: 0 }, -->
<!--       { type: "point", id: "B1", x: 2, y: 0 }, -->
<!--       { type: "point", id: "C1", x: 2, y: sqrt3 }, -->
<!--       { type: "segment", points: ["A1", "B1"] }, -->
<!--       { type: "segment", points: ["B1", "C1"] }, -->
<!--       { type: "segment", points: ["C1", "A1"] }, -->
<!--       { type: "angle", points: ["C1", "B1", "A1"], label: "π/6" }, -->

<!--       // Labels for Triangle 1 -->
<!--       { type: "label", point: { x: 1, y: -0.3 }, text: "2" }, -->
<!--       { type: "label", point: { x: 2.2, y: sqrt3 / 2 }, text: "√3" }, -->
<!--       { type: "label", point: { x: 1, y: sqrt3 / 2 }, text: "1" }, -->

<!--       // Triangle 2: sides 1, 1, √2 (π/4) -->
<!--       { type: "point", id: "A2", x: 4, y: 0 }, -->
<!--       { type: "point", id: "B2", x: 5, y: 0 }, -->
<!--       { type: "point", id: "C2", x: 5, y: 1 }, -->
<!--       { type: "segment", points: ["A2", "B2"] }, -->
<!--       { type: "segment", points: ["B2", "C2"] }, -->
<!--       { type: "segment", points: ["C2", "A2"] }, -->
<!--       { type: "angle", points: ["C2", "B2", "A2"], label: "π/4" }, -->

<!--       // Labels for Triangle 2 -->
<!--       { type: "label", point: { x: 4.5, y: -0.3 }, text: "1" }, -->
<!--       { type: "label", point: { x: 5.2, y: 0.5 }, text: "1" }, -->
<!--       { type: "label", point: { x: 4.6, y: 0.6 }, text: "√2" }, -->

<!--       // Triangle 3: sides √3, 1, 2 (π/3) -->
<!--       { type: "point", id: "A3", x: 7, y: 0 }, -->
<!--       { type: "point", id: "B3", x: 9, y: 0 }, -->
<!--       { type: "point", id: "C3", x: 9, y: 1 }, -->
<!--       { type: "segment", points: ["A3", "B3"] }, -->
<!--       { type: "segment", points: ["B3", "C3"] }, -->
<!--       { type: "segment", points: ["C3", "A3"] }, -->
<!--       { type: "angle", points: ["C3", "B3", "A3"], label: "π/3" }, -->

<!--       // Labels for Triangle 3 -->
<!--       { type: "label", point: { x: 8, y: -0.3 }, text: "2" }, -->
<!--       { type: "label", point: { x: 9.2, y: 0.5 }, text: "1" }, -->
<!--       { type: "label", point: { x: 8, y: 0.6 }, text: "√3" } -->
<!--     ]); -->
<!--   </script> -->
