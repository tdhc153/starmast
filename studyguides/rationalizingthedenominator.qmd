...
*Before reading this guide, it is recommended that you read [Guide: Laws of indices](lawsofindices.qmd) and [Guide: Expanding brackets]. The only irrational numbers you will see in this guide are square roots. If you want to learn more about irrational numbers, have a look at [Overview: Types of numbers].*
