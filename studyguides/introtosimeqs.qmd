...
Since linear equations in two variables can be plotted along an $x$ and $y$ axis (see [Guide: Introduction to linear equations]), it can help to think about simultaneous equations from a graphical perspective. 
...
$$2x+3(4x-5)=7$$
This gives you an equation with only $x$. After expanding the brackets and simplifying the equation, you find that $x=11/7$.
