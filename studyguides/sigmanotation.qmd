...
$\displaystyle \begin{array}{cccccccccccc}& S & = & 1 & + & 2 & + & 3 & + & \ldots & + & N \\ + & S & = & N & + & (N-1) & + & (N-2) & + & \ldots & + & 1\\\hline & 2S & = & (N+1) & + & (N+1) & + & (N+1) & + & \ldots & + & (N+1)\end{array}$
...
v1.0: initial version created 08/23 by Ifan Howells-Baines and Mark Toner as part of a University of St Andrews STEP project.
  ...
  - v1.1: edited 05/24 by tdhc, and split into an introductory guide and a further topics guide.
