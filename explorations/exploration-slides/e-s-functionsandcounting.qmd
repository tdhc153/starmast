...
- Write $$\mathbb{N}_0\times \mathbb{N}_0\ = \{(n,k)\; : \; n,k\in \mathbb{N}_0\}.$$ Then the binomial coefficient can be written as a function $b:\mathbb{N}_0\times \mathbb{N}_0\times \mathbb{N}$ with $$b(n,k) = \binom{n}{k}.$$
...
## Cardinalities (3/3) {data-background-image="slides-bg.png"}
