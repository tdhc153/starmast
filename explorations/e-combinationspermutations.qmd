...
In the second of four linked presentations, this session looks at counting the number of ways you can choose objects from a larger set of objects. This is achieved by looking at binomial coefficients (where the order of choice doesn't matter) and falling factorials (where the order of choice does matter). Along the way, you will double-check marketing materials for a food truck, and learn how to win at cards.
