...
abstract: A readme for how to write study guides for the STARMAST project. This is a dynamic document (and unfinished as of the initial commit on 26/05/23), and will contain updates once the project gets into full swing and issues/comments are found and added.
...
- These questions should not be too difficult, instead giving a quick way for students to check understanding before they attempt the question sheet. 
...
2. A paragraph of **presumed knowledge**: relating any presumed knowledge to the contents of the guide. A link to the study gide should always be included.
...
2. A paragraph of **presumed knowledge**: relating any presumed knowledge to the contents of the guide. A link to the study guide *and* a link to the questions should always be included.
