...
Therefore, there's **no such thing as a trick** on this website. 'Technique' or 'tool' are far better words for our purposes. Every time you feel the need to use a 'trick' that you learned, consider writing out the working in full. 
...
- Important (always/should do this), warning (never do this), tip (could do this), note (main content of guide).
...
- Avoid works like 'thus', 'hence', 'whence', 'whenceforth', 'ergo'; use words like 'so', 'therefore', 'it follows that'.
...
- [Working with units? Make sure they're properly formatted!](https://physics.nist.gov/cuu/Units/checklist.html)
