...
3.1. $\quad$ The denominator of the expression $\dfrac{\sqrt{11}}{2\sqrt{3}+\sqrt{5}}$ is not of the form $b + c\sqrt{d}$, where $b$, $c$ and $d$ are integers but you can still rationalize the denominator.

Prove that $\dfrac{\sqrt{11}}{2\sqrt{3}+\sqrt{5}} = \dfrac{2\sqrt{33}-\sqrt{55}}{7}$
