...
As of 10 July 2026, we have **44** study guides on **42** topics, with **44** question sheets, **44** answer sheets, **1** overview page, **4** explorations with accompanying slides, **23** fact sheets, **6** proof sheets, **12** interactive calculators, and **11** other interactive resources for a total of **193** pages of resources. All of our written resources can be found in our [**full index**](fullindex.qmd), and our subsidiary interactive resources can be found in our [**app list**](applist.qmd).

The principles behind our approach to accessibility can be found in the [rationale for accessibility and inclusion page (clickable link)](rationale.qmd). All of our resources are **free to use, and they always will be**, and you can **modify them for your own ends** (with some restrictions); [please see our licensing page for more (clickable link)](license.qmd).
...
Alongside the web version, *every* written resource on the site has both a **downloadable and printable pdf version** and an **accessible, downloadable and editable Microsoft Word document** attached. You can find these versions on the right hand side of every page, underneath the document structure. In addition, every study guide has a **downloadable mp3 narration** which can be found at the topic of the page.
...
In particular, if you would like to contribute, please email tdhc (at the address above), and see the [list of wanted topics](ttdl.qmd), the [style guide for writers](styleguide.qmd), and the [readme file on the github repository](https://github.com/tdhc153/starmast).
...
Semester 2 team: Jakub Brzozowski, Holly Goldsmith, Millie Harris, Madeline Koenig, Jessica Taberner.
...
We would not exist without the Vertically Integrated Project scheme at the University of St Andrews.
