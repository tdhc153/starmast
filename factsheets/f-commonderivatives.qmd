...
For more about where these came from, please see [Guide: Introduction to differentiation and the derivative](../studyguides/introtodifferentiation.qmd) and [Proof: Derivatives of other common functions].
