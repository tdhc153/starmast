---
title: "Factsheet: $t$-distribution"
author: Michelle Arnetta and Tom Coleman
abstract-title: Summary
abstract: A factsheet for the $t$-distribution.
filters: 
  - shinylive
...
![An example of the $t$-distribution with $\nu = \textsf{df} = 2$ and $\mu = 0$.](./FiguresPNG/f-tdist.png){width="80%"}
