...
\begin{tcolorbox}[enhanced jigsaw, colback=white, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, rightrule=.15mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Definition of sum and sigma notation}, toprule=.15mm, arc=.35mm, opacityback=0, leftrule=.75mm, left=2mm, toptitle=1mm, titlerule=0mm, coltitle=black]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, colframe=quarto-callout-note-color-frame, arc=.35mm, opacityback=0, leftrule=.75mm, left=2mm, rightrule=.15mm, toprule=.15mm, bottomrule=.15mm, breakable]
