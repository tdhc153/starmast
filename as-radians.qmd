...
1.2. Mulitplying $105^\circ$ by $\pi$ and dividing by $180$ gives $\frac{105\pi}{180} \textrm{rad} = \frac{7\pi}{12} \textrm{rad} \approx 0.583 \textrm{rad}$.

1.3. Mulitplying $298^\circ$ by $\pi$ and dividing by $180$ gives $\frac{298\pi}{180} \textrm{rad} = \frac{149\pi}{90} \textrm{rad} \approx 1.66 \textrm{rad}$.

1.4. Mulitplying $61^\circ$ by $\pi$ and dividing by $180$ gives $\frac{61\pi}{180} \textrm{rad} \approx 0.339 \textrm{rad}$.

1.5. Mulitplying $353^\circ$ by $\pi$ and dividing by $180$ gives $\frac{353\pi}{180} \textrm{rad} \approx 1.96 \textrm{rad}$.
...
2.5.  Multiplying $5\textrm{rad}$ by $180$ and dividing by $\pi$ gives $\frac{900}{180\pi} ^\circ = \frac{5}{\pi} ^\circ \approx 1.59 ^\circ$.
