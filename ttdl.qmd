...
- Rationalizing the denominator (priority, Max)
- Multiple revolutions and negative angles
- Introduction to complex numbers (tdhc drafting, 09/09)
- Artihmetic on complex numbers (Charlotte)
- Factorization
- Even and odd functions
- Trigonometry and integration (Sophie C)
- Solving simultaneous equations (priority, Ollie)
...
- PMFs and PDFs
- Introduction to hypothesis testing (Ellie)
